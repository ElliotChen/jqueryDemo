...
//	private static JsonMapper mapper = JsonMapper.buildNonDefaultMapper();
	public static final String toJson(Page<?> page) {
		ObjectMapper mapper = new ObjectMapper();
//		mapper.configure(Feature., false);
		String result = "Fail";
		try {
			result = mapper.writeValueAsString(toDataTableTO(page));
		} catch (Exception e) {
	...
	protected static <T> DataTableTO<T> toDataTableTO(Page<T> page) {
